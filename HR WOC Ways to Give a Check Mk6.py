# Ways to Give a Check Mk6

# Finished For Now, Can Discard/Store Away the Other Test Cases


# Closer than ever
# Can't solve test case 2
# Solved Case 2

# Possibility that dis checks supercede promoted checks
# So even if I promote a pawn to a Queen/Bishop and that results in a check
# But by moving the pawn I get a single discovered check

###################3
# Number of promotions resulting in a check, this means max 4 no matter what!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# Corrected this and now the program passes the 4 test cases!!!!
