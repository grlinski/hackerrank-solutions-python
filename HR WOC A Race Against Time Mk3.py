...
# Ways to Speed Up
# 1 Remove Anything With too High a total price
# Start summing prices as I go along, if something is say 75% near the sum of the prices so far eliminate it.
# 2 Remove anything over a certain price
...
def raceAgainstTime(n, mason, h, p):
    ...
    for i in range(0,n-1):
        print('Position',i)
        allPrices = allPrices+p[i]

        pEF = 0.55
        priceElim = (allPrices/(i+1))*pEF
