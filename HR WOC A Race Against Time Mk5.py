...
# MK5 Changes
# What about when every time we hit a new max height, meaning every item has to be at that height we eliminate everything but the lowest scorer





# A Race Against Time Mk5
